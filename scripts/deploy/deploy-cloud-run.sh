...
# Properly escape the private key for Cloud Run
ENV_VARS="$ENV_VARS,FIREBASE_PRIVATE_KEY=$(echo "$FIREBASE_PRIVATE_KEY" | sed 's/"/\\"/g')"
ENV_VARS="$ENV_VARS,FIREBASE_API_KEY=$FIREBASE_API_KEY"
ENV_VARS="$ENV_VARS,FIREBASE_MESSAGING_SENDER_ID=1234567890"
ENV_VARS="$ENV_VARS,FIREBASE_APP_ID=1:1234567890:web:abcdef1234567890"
